...
require (
	...
	github.com/openshift/library-go v0.0.0-20250606192531-1aaedc999e7c
...
replace github.com/openshift/oc => ../oc

replace github.com/openshift/library-go/pkg/image/registryclient/v2 => ../library-go/pkg/image/registryclient/v2
